...
EOF
#=========================================================
# 21. run minos_bran program for fundamental R  mode,
# where,  n=0, 0 < f <  0.2 Hz,
#
echo "Step 21: minos_bran runs for R modes ....................."
echo "============== Program minos_bran =================="
null=`ls * | grep '_R$'`
if test "X$null" != X; then 
rm -f $null
...
EOF
#============================================================
# 4. Convert minos_bran results to .eigen relation (R mode)
echo "Step 41: eigen for R ....................................."
