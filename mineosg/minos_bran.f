...
c JT
      scale=dsqrt(pi*6.6723d-11*5515.0d0)
      g=9.81d0/(6371.0d3*scale*scale) !non-dimensionalized g at the surface
      om=wcom/scale !non-dimensionalized angular frequency
      if(jcom.eq.1) then !radial
        av=a(1,n)+2.0d0*g*a(1,n)/(om*om)
        ah=0.0d0
        ap=0.0d0
      elseif(jcom.eq.3) then !spheroidal
        av=a(1,n)+2.0d0*g*a(1,n)/(om*om)
     .       +fl1*a(5,n)/(om*om)
        ah=a(3,n)/sfl3-g*a(1,n)/(om*om)
     .       -a(5,n)/(om*om)
        ap=a(5,n)
      else !toroidal
        av=0.0d0
      ...
      write(ioeig) nord,l,wcom,qmod,av,ah,ap,(buf(i),i=1,nvec)
...
c*** propagate the minor vector in a fluid region from level jf to jl ***
     ...
     +  fl1,fl2,fl3,sfl3,jcom,nord,l,kg,kount,knsw,ifanis,iback
      common/eifx/ar(14,mk),inorm(mk),jjj(mk)
      common/shanks/b(46),c(10),dx,step(8),stepf,maxo,in
      dimension f(*),h(nvefm,1000),s(5),fp(5)
      data econst/1048576.d0/
      if(nvefm.eq.1) then
        do i=jl,jf
          inorm(i)=inorm(i)+iexp
...
c                                                     -rpb
      ...
      dimension x(*),y(*),q(3,1000),f(3,1000),yy(3)
      equivalence (yy(1),y0)
      data yy/3*0.d0/
      j1=i1+1
      y0=0.d0
