 ...
 !
 ! maximum number of points per region =       349609
 !
 ! on NEC SX, make sure "loopcnt=" parameter
 ! in Makefile is greater than max vector length =      1048827
 !
 ! total elements per slice =         5967
 ! total points per slice =       406615
 !
 ...
 ! ----------------------------------------------
 !
 ! size of static arrays per slice =   0.109742585569620       GB
 !
 !   (should be below to 80% or 90% of the memory installed per core)
 !   (if significantly more, the job will not run by lack of memory )
 !
 ! size of static arrays for all slices =    42.1411528587341       GB
 !                                      =   4.115346958860755E-002  TB
 !
 
 integer, parameter :: NEX_XI_VAL =          192
 integer, parameter :: NEX_ETA_VAL =          192
 
 integer, parameter :: NSPEC_CRUST_MANTLE =         5184
 integer, parameter :: NSPEC_OUTER_CORE =          540
 integer, parameter :: NSPEC_INNER_CORE =          243
 integer, parameter :: NSPEC_TRINFINITE =            0
 integer, parameter :: NSPEC_INFINITE =            0
 
 integer, parameter :: NGLOB_CRUST_MANTLE =       349609
 integer, parameter :: NGLOB_OUTER_CORE =        38585
 integer, parameter :: NGLOB_INNER_CORE =        18421
 integer, parameter :: NGLOB_TRINFINITE =            0
 integer, parameter :: NGLOB_INFINITE =            0
 
 integer, parameter :: NSPECMAX_ANISO_IC =            1
 
 integer, parameter :: NSPECMAX_ISO_MANTLE =         5184
 ...
 integer, parameter :: NSPEC2DMAX_XMIN_XMAX_CM =          396
 integer, parameter :: NSPEC2DMAX_YMIN_YMAX_CM =          396
 integer, parameter :: NSPEC2D_BOTTOM_CM =           36
 integer, parameter :: NSPEC2D_TOP_CM =          576
 integer, parameter :: NSPEC2DMAX_XMIN_XMAX_IC =           81
 integer, parameter :: NSPEC2DMAX_YMIN_YMAX_IC =           81
 integer, parameter :: NSPEC2D_BOTTOM_IC =            9
 integer, parameter :: NSPEC2D_TOP_IC =            9
 integer, parameter :: NSPEC2DMAX_XMIN_XMAX_OC =          111
 integer, parameter :: NSPEC2DMAX_YMIN_YMAX_OC =          114
